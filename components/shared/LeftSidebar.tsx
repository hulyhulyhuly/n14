...
const LeftSidebar = () => {
  ...
  return (
    <section className="background-light900_dark200 light-border custom-scrollbar sticky left-0 top-0 flex h-[100svh] flex-col justify-between overflow-y-auto border-r p-6 pt-36 shadow-light-300 dark:shadow-none max-sm:hidden lg:w-[266px]">
      <div className="flex flex-1 flex-col gap-6">
        {sidebarLinks.map((sb) => {
          const isActive =
            (pathname.includes(sb.route) && sb.route.length > 1) ||
            pathname === sb.route;
